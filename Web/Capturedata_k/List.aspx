<%@ Page Title="capturedata_k" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="KiwiCrawler.Web.Capturedata_k.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="kId" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="kUrl" HeaderText="kUrl" SortExpression="kUrl" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="kCaptureDateTime" HeaderText="kCaptureDateTime" SortExpression="kCaptureDateTime" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="kId" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="kId" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
